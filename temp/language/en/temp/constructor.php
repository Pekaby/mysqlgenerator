...
.bloack_ad {display: none;}
  ...
  <script src="src/ihavecookies/jquery.ihavecookies.min.js"></script>
</head>
<body>
<header>
...
<form action="/constructor" method="get" class="needs-validation">
	...
	<label for="">Name of table:</label><br>
	...
	<br><br>
	<label for="">How many records do you need?</label><br>
	...
	<h6>Notice: If you select 500 records or more, the generation can last up to 2 minutes.<h6><br>
	...
	<button type="submit" name="start_singl" сlass="btn btn-primary btn-lg btn-block">Start</button>
...
<form action="/feedback" method="post">
	...
	<br><br>
	<textarea name="feed_back" id="" cols="50" rows="5" placeholder=" your feedback..."></textarea><br><br>
	<?
	if ($_GET['ef'] == '0x00001fx') {
		echo "<divstyle=\"color:red;\">Something went wrong. Try again later!</div><br>";
	}
	?>
	<button type="submit" name="dofeed">Submit</button>
</form>
